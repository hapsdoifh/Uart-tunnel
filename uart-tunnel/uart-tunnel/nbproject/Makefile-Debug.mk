...
${OBJECTDIR}/src/c-serial-com.o: src/c-serial-com.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Iinclude -I../../libgws_sk/gws_sk -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/c-serial-com.o src/c-serial-com.c

${OBJECTDIR}/src/instance_ctrl.o: src/instance_ctrl.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Iinclude -I../../libgws_sk/gws_sk -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/instance_ctrl.o src/instance_ctrl.c

${OBJECTDIR}/src/main.o: src/main.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Iinclude -I../../libgws_sk/gws_sk -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.c
